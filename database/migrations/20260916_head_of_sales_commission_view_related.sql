...
-- Head of Sales can only view commissions assigned to their own user/email.
-- Creation, editing, deletion, payment management and installment management
-- remain restricted to roles with manage_all.
