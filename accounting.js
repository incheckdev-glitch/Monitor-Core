    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>InCheck360 Expense Report</title><style>
      ...
      *{box-sizing:border-box}
      ...
      <main class="report" data-expense-report-pdf>
        <header class="brand-header"><img class="logo" src="${esc(logoUrl)}" alt="InCheck360"><div class="company"><strong>Incheck 360 FZC</strong>Business Centre, Sharjah Publishing City Free Zone, Sharjah, United Arab Emirates<br>License No. 4431674.01<br>info@incheck360.nl</div></header>
